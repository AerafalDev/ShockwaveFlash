...
public abstract class Avm1ConverterFactory : Avm1Converter
{
    ...
    internal sealed override object? ReadBoxed(Avm1Value value, Avm1SerializerOptions options) => throw new NotSupportedException();

    internal sealed override Avm1Value WriteBoxed(object? value, Avm1SerializerOptions options) => throw new NotSupportedException();
}
