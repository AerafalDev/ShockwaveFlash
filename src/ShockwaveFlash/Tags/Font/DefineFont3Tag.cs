...
public sealed class DefineFont3Tag : Tag
{
    ...
    public DefineFont3Tag(TagMetadata metadata, ushort id, string name, Language language, FontLayout? layout, FontGlyph[] glyphs, FontFlags flags) : base(metadata)
    {
        Id = id;
        Name = name;
        Language = language;
    ...
    public static DefineFont3Tag Decode(MemoryReader reader, TagMetadata metadata, byte swfVersion)
    {
