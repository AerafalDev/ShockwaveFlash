...
public abstract class Tag
{
    ...
    private static Tag Decode(MemoryReader reader, TagMetadata metadata, byte swfVersion)
    {
        return metadata.Code switch
        {
            ...
            TagCode.DefineText => DefineTextTag.Decode(reader, metadata, 1),
            ...
            TagCode.DefineText2 => DefineTextTag.Decode(reader, metadata, 2),
            ...
            TagCode.DefineMorphShape => DefineMorphShapeTag.Decode(reader, metadata, swfVersion, 1),
            TagCode.DefineFont2 => DefineFont2Tag.Decode(reader, metadata, swfVersion, 2),
            ...
            TagCode.DefineFont3 => DefineFont2Tag.Decode(reader, metadata, swfVersion, 3),
            ...
            TagCode.DefineMorphShape2 => DefineMorphShapeTag.Decode(reader, metadata, swfVersion, 2),
