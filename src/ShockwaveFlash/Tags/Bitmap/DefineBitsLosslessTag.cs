...
public sealed record DefineBitsLosslessTag(TagMetadata Metadata, ushort Id, ushort Width, ushort Height, BitmapFormat Format, ReadOnlyMemory<byte> ZLibBitmapData) : Tag(Metadata)
{
